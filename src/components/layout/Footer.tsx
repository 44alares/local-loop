...
const stats = [
  { icon: Leaf, label: 'CO₂ Saved', value: '12,450 kg' },
  { icon: MapPin, label: 'Cities', value: '150+' },
  { icon: Users, label: 'Makers', value: '2,300+' },
];
    ...
    <footer className="border-t border-border bg-cream-dark/30">
      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="flex items-center gap-4 p-6 rounded-xl bg-background shadow-card"
            >
      ...
      <div className="border-t border-border">
        <div className="container py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 MakeHug. All rights reserved.
          </p>
