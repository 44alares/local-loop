...
const breakdownRowConfig = [
  {
    ...
    rowClass: 'py-1.5 border-t border-border -mx-4 px-4',
    valueClass: 'font-bold text-muted-foreground text-sm',
    labelClass: 'font-medium text-muted-foreground text-xs',
  },
  {
    key: 'designer',
