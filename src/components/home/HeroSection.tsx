        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block">
            <div className="relative aspect-square">
              ...
              {/* Floating Cards */}
              <div className="absolute -left-8 top-1/4 p-4 bg-background rounded-xl shadow-card-hover animate-float" style={{ animationDelay: '0s' }}>
              ...
              <div className="absolute -right-4 bottom-1/4 p-4 bg-background rounded-xl shadow-card-hover animate-float" style={{ animationDelay: '2s' }}>
                <div className="flex items-center gap-3">
                  <img
