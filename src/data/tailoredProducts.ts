...
export const tailoredProducts: TailoredProduct[] = [
  ...
  },
  {
    ...
    previewVariants: [
      { label: 'Small (50×50)', params: { lengthH: 50, heightV: 50, thickness: 6, reinforcement: false, holeDiameter: 5 } },
      { label: 'Large + reinf.', params: { lengthH: 180, heightV: 120, thickness: 12, reinforcement: true, holeDiameter: 8 } },
      { label: 'Medium no reinf.', params: { lengthH: 100, heightV: 80, thickness: 8, reinforcement: false, holeDiameter: 6 } },
      { label: 'Wide + reinf.', params: { lengthH: 200, heightV: 100, thickness: 10, reinforcement: true, holeDiameter: 6 } },
    ],
  },
];
