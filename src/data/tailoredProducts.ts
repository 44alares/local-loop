...
export const tailoredProducts: TailoredProduct[] = [
  {
    ...
    previewVariants: [
      { label: 'Short (80mm)', params: { length: 80, holeSpacing: 64, legHeight: 25, thickness: 8 } },
      { label: 'Long (200mm)', params: { length: 200, holeSpacing: 160, legHeight: 30, thickness: 10 } },
      { label: 'Tall legs (120mm)', params: { length: 120, holeSpacing: 96, legHeight: 50, thickness: 10 } },
      { label: 'Thick (160mm)', params: { length: 160, holeSpacing: 128, legHeight: 30, thickness: 16 } },
    ],
  },
  {
  ...
  },
  {
    ...
    previewVariants: [
      { label: 'Small (50×50)', params: { lengthH: 50, heightV: 50, thickness: 6, reinforcement: false } },
      { label: 'Large + reinf.', params: { lengthH: 180, heightV: 120, thickness: 12, reinforcement: true } },
      { label: 'Medium no reinf.', params: { lengthH: 100, heightV: 80, thickness: 8, reinforcement: false } },
      { label: 'Wide + reinf.', params: { lengthH: 200, heightV: 100, thickness: 10, reinforcement: true } },
    ],
  },
];
