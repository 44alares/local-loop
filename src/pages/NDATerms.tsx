        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-3 text-muted-foreground">
              ...
              <li>
                <strong className="text-foreground">C. Prohibition on substantially similar designs:</strong> The Designer may not upload designs that are identical to, or substantially similar to, any design already available on the Platform. The Platform uses automated similarity detection tools to identify potential copies, derivatives, or remixes. Flagged designs may be hidden, suspended, or removed, and the Designer's account may be suspended for repeated violations.
              </li>
              <li>
