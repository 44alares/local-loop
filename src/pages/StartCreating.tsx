                  ...
                  <Collapsible open={creatorTermsOpen} onOpenChange={(open) => {
                    ...
                    <CollapsibleContent>
                      <div className="mt-3 p-4 bg-muted/50 rounded-lg text-sm text-muted-foreground space-y-3 max-h-[400px] overflow-y-auto">
                        ...
                        <p><strong className="text-foreground">Originality &amp; third-party uploads.</strong> You may upload a design to MakeHug if you are the original creator/rights holder (including designs you previously published on other platforms) or if you have explicit permission from the rights holder.
You may not upload, list, resell, or monetize files you didn’t create or don’t have rights to commercialize, including files taken from third‑party repositories, other designers, or subscription/membership sources, or files under licenses/terms that don’t allow this use.</p>
