...
You may not upload, list, resell, or monetize files you didn’t create or don’t have rights to commercialize, including files taken from third‑party repositories, other designers, or subscription/membership sources, or files under licenses/terms that don’t allow this use.
            <p className="text-muted-foreground mb-3">
