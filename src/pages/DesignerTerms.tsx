      ...
      <section className="container py-12 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-muted-foreground mb-3">
              <strong className="text-foreground">Originality &amp; third-party uploads.</strong> You may upload a design to MakeHug if you are the original creator/rights holder (including designs you previously published on other platforms) or if you have explicit permission from the rights holder.
