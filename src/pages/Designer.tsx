          ...
          <div className="flex items-start gap-4 md:grid md:grid-cols-2 md:gap-10 md:items-center">
            <div className="flex-1">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-4">
                ...
                <span className="text-secondary">Get paid when it gets printed.</span>
              </h1>
              <p className="text-base md:text-lg text-muted-foreground mb-6">
                Turn your STL into real parts made by local makers in the network. You keep creating—we help with orders, payouts, and support.
              </p>
        ...
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Focus on what you do best — designing. We help with production flow, payments, and customer support.
            </p>
          </div>
            ...
            <div className="relative">
              <div className="bg-card rounded-xl p-6 shadow-card">
                ...
                <ul className="space-y-3">
                  {['Portfolio or 3+ original STL designs', 'IP declaration confirming original work', 'Agreement to our royalty terms', 'Payment method for royalty payouts'].map((item, i) => <li key={i} className="flex items-start gap-2">
